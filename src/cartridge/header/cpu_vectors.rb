    ...
    class CpuVectors
        class << self
            ...
            def native_mode_vectors(raw_rom, addr)
                # print addresses native
                # puts "native cop #{addr.to_s(16)}"
                # puts "native irq #{(addr+10).to_s(16)}"
                {
            ...
            def emulation_mode_vectors(raw_rom, addr)
                # print emulation addresses
                # puts "emulation cop #{(addr+16).to_s(16)}"
                # puts "emulation none #{(addr+18).to_s(16)}"
                # puts "emulation abort #{(addr+20).to_s(16)}"
                # puts "emulation nmi #{(addr+22).to_s(16)}"
                # puts "emulation reset #{(addr+24).to_s(16)}"
                # puts "emulation irq #{(addr+26).to_s(16)}"
                {
